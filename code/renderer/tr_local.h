...
extern cvar_t	*r_frameMultisampling;	// 0/1 = Off, 2..N = frames blended per shown image (temporal accumulation); Vulkan-only; latched
...
extern	cvar_t	*r_perPixelLighting;			// Blinn-Phong specular layer (Vulkan only)
extern	cvar_t	*r_specExponent;				// Blinn-Phong specular sharpness
extern	cvar_t	*r_specScale;					// Blinn-Phong specular intensity
