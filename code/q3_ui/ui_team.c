...
void TeamMain_MenuInit( void ) {
	...
	s_teammain.joinred.string           = "ENTRAR NO VERMELHO";
	...
	s_teammain.joinblue.string           = "ENTRAR NO AZUL";
	...
	s_teammain.joingame.string           = "ENTRAR NO JOGO";
	...
	s_teammain.spectate.string           = "ASSISTIR";
