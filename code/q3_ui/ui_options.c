...
void Options_MenuInit( void ) {
	...
	s_options.banner.string		    = "CONFIGURACAO DE SISTEMA";
	...
	s_options.graphics.string			= "GRAFICOS";
	...
	s_options.display.string			= "VIDEO";
