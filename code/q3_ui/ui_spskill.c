...
static void UI_SPSkillMenu_Init( void ) {
	...
	skillMenuInfo.art_banner.string				= "DIFICULDADE";
	...
	skillMenuInfo.item_baby.string				= "Posso Vencer";
	...
	skillMenuInfo.item_easy.string				= "Manda Ver";
	...
	skillMenuInfo.item_medium.string			= "Me Castigue";
	...
	skillMenuInfo.item_nightmare.string				= "PESADELO!";
